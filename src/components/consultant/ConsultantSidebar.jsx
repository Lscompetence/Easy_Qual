...
import { LayoutDashboard, FolderOpen, Calendar, BookOpen, Settings, LogOut, MoreVertical } from 'lucide-react'
...
export default function ConsultantSidebar() {
    ...
    return (
        <aside className="w-64 bg-white h-screen sticky top-0 flex flex-col z-50 flex-shrink-0">
            {/* Logo Section */}
            {/* Logo Section - Merged Border */}
            <div className="h-16 flex items-center px-6 border-b border-gray-100 justify-between mr-[1px]">
                <Logo size="small" color="purple" />
                {/* Credit Badge for sidebar */}
