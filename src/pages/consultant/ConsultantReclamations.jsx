                                                    ...
                                                    <tr key={ticket.id} className="hover:bg-slate-50/50 transition-colors">
                                                        <td className="px-6 py-4 whitespace-nowrap">
                                                            <div className="flex flex-col">
                                                                ...
                                                                <span className="inline-self-start mt-1 text-[9px] font-black px-1.5 py-0.5 rounded uppercase tracking-wider bg-purple-50 text-purple-600 border border-purple-100 w-max">
                                                                    {role}
                                                                </span>
                                                            </div>
                                                        </td>
                    ...
                    <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden animate-in zoom-in-95 duration-200 border border-slate-100">
                        ...
                        <div className="px-6 pb-6">
                            ...
                            <div className="mb-8">
                                ...
                                <div className="mt-2 bg-gradient-to-br from-slate-50 to-slate-100/50 p-5 rounded-2xl border border-slate-100 shadow-sm relative">
                                    <div className="absolute left-0 top-4 bottom-4 w-1 bg-blue-400 rounded-r-md opacity-50"></div>
                            ...
                            <div className="flex justify-end pt-2">
                                <button 
                                    ...
                                    className="px-6 py-2.5 bg-blue-600 text-white text-sm font-bold rounded-xl hover:bg-blue-700 shadow-sm hover:shadow transition-all active:scale-[0.98]"
                                >
                                    Fermer les détails
                                </button>
                            </div>
