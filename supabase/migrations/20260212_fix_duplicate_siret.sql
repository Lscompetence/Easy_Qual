-- UPDATE create_case_and_debit to handle existing Tenants (Duplicate SIRET)
...
BEGIN
  ...
  ON CONFLICT (siret) 
  DO UPDATE SET name = EXCLUDED.name -- Update name if changed, and ensure ID is returned
